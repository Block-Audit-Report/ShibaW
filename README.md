...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address deployerAddress)
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x4f381d5fF61ad1D0eC355fEd2Ac4000eA1e67854); 
        ...
        emit Transfer(address(deployerAddress), ReceiveAddress, _totalSupply);
    }
...
contract ShibaW is BEP20 {
    constructor() BEP20(
        ...
        [0x7e5CaAD4b6a3bbcdB9F463d95393a446019CAfa9,0x7e5CaAD4b6a3bbcdB9F463d95393a446019CAfa9],
        0x7e5CaAD4b6a3bbcdB9F463d95393a446019CAfa9,
